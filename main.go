...
func init() {
	flag.Usage = func() {
		fmt.Println("Usage: ilo5_exporter [ ... ]\n\nParameters:")
		fmt.Println()
		flag.PrintDefaults()
	}
}
...
func startServer() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(`<html>
			...
			<p><a href="https://github.com/MauveSoftware/ilo5_exporter">github.com/MauveSoftware/ilo5_exporter</a></p>
			</body>
			</html>`))
	})
